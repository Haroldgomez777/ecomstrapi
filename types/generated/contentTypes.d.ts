...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cost: Attribute.Component<'cost.cost'>;
    lines: Attribute.Relation<
      'api::cart.cart',
      'oneToMany',
...
export interface ApiCartItemCartItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cost: Attribute.Component<'cost.cost', true>;
    merchandise: Attribute.Component<'merchandise.merchandise'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    options: Attribute.Relation<
      ...
      'api::product-option.product-option'
    >;
    priceRange: Attribute.Component<'price-range.price-range', true>;
